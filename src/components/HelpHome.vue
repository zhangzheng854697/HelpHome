...
<style scoped>
	...
	@media screen and (max-width: 800px) {
		.main>div>span{width: 22%}
		.main>div>.el-input,.main>div .el-textarea,.main>div .el-select{width: 73%;}
	}
	.ImageBox{margin-top:20px;}
	h2{font-size:24px;margin:10px 0;}
	>>>.el-dialog__body{padding:0px 20px 30px 20px;}
	>>>.el-dialog__body span{font-size:16px;text-align: left;}
