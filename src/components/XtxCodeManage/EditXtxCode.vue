  ...
  <div id="app">
    ...
    <div class="content">
      <el-row >
        ...
        <el-col>
          <span>序列号 :</span>
          <el-input v-model="License" disabled placeholder="请输入序列号">
...
<script type="text/javascript">
  ...
  data() {
	...
	methods:{
        ...
        let EndData = _that.getDateStr(res.C_EndDate)
        let StartDate = _that.getDateStr(res.C_StartDate)
        _that.SelectTime = [new Date(StartDate),new Date(EndData)]
